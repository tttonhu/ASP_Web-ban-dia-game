...
If(Request.ServerVariables("REQUEST_METHOD")="POST")THEN
    ...
    introduction = Request.form("introduce")
    price =Request.form("price")
    amountleft=Request.form("howmany")
    picm = Request.form("picture")
    pic1 = Request.form("image1")
    pic2 = Request.form("image2")
    pic3 = Request.form("image3")
    pic4 = Request.form("image4")
    pic5 = Request.form("image5")
    pict = Request.form("imaget")
    picb = Request.form("imageb") 

    If (NOT IsNull(nameitem)) Then 
        ...
        If Result.EOF then 
            ...
            cmdPrepp1.Parameters(0)= nameitem
            cmdPrepp1.parameters(1)= genre
            cmdPrepp1.parameters(2)= introduction
            cmdPrepp1.parameters(3)= price
            cmdPrepp1.parameters(4)= amountleft
            cmdPrepp1.parameters(5)= picm
            cmdPrepp1.parameters(6)= pic1
            cmdPrepp1.parameters(7)= pic2
            cmdPrepp1.parameters(8)= pic3
            cmdPrepp1.parameters(9)= pic4
            cmdPrepp1.parameters(10)= pic5
            cmdPrepp1.parameters(11)= pict
            cmdPrepp1.parameters(12)= picb
            Set resultt = cmdPrepp1.execute()
        Else
            Session("Error") = "Item has exist !"
        End If
    End If
End If
